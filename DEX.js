    ...
    const serverUrl = "https://zlnjedlgfzi6.usemoralis.com:2053/server";
    const appId = "ZoIblRBKMAZxA7EbTQCZrwNGNYBA3GekmxNPlRYB";
    Moralis.start({ serverUrl, appId });

    Moralis
        .initPlugins()
        .then(() => console.log('Plagins have been initialized.'));
    ...
    const tokenValue =(value, decimals) => 
        ...
        /**Login-logout and initilizations*/
    // MetaMask connection
    ...
    async function swap(event){
        ...
        document.querySelector('.js-form-container').innerHTML = '';
    }
    ...
    async function getStats(){
        ...
        <tr>
            ...
            <td>
                <button class = "js-swap btn btn-outline-success" 
    ...
    async function logOut() {
      ...
      async function formSubmitted(event){
        ...
        // Submission of the quote reuest 
        ...
        const [toTokenAddress, toDecimals] = document.querySelector('[name: to-token]').value.split('-');
            ...
            try {
                    ...
                    document.querySelector('.js-form-container').innerHTML = `
                        ...
                        <button class="btn js-swap btn-outline-info">Perform Swap</button>
                    `;
